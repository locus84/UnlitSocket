...
namespace UnlitSocket
{
    ...
    public partial class Message
    {
        ...
        public Message(ArraySegment<byte> segment)
        {
            buffer = segment;
        }
        ...
        public string ReadString()
        {
            ...
            if (realSize >= Message.MaxStringLength)
            {
                throw new EndOfStreamException("ReadString too long: " + realSize + ". Limit is: " + Message.MaxStringLength);
            }
